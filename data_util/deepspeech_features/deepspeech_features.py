...
def prepare_deepspeech_net(deepspeech_pb_path):
    ...
    logits_ph = graph.get_tensor_by_name("logits:0") ## initially name was "deepspeech/logits:0" changed on Nov 9th 23:12
    input_node_ph = graph.get_tensor_by_name("input_node:0") ## similarly as above
    input_lengths_ph = graph.get_tensor_by_name("input_lengths:0") ## similarly as above
